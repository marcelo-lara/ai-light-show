"""
Test runner for the LangGraph-based song analysis pipeline.
"""
...
# Try to import the actual pipeline, fall back to simple pipeline if there are issues
try:
    from song_analysis.langgraph_pipeline import run_pipeline
    print("Using full LangGraph pipeline")
except ImportError:
    from song_analysis.simple_pipeline import run_pipeline
    print("Using simplified pipeline (fallback)")
